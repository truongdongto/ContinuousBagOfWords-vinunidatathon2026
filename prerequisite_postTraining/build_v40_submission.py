"""Optimize ensemble weights for v40, mean-scale to v17m, build submission."""
...
print("=== Building submission for v40_pattern (v6 + 6 inventory feats) ===")
d = np.load(SCRIPT_DIR / 'ml_v40_pattern_preds.npz', allow_pickle=True)
...
out_path = DIAG_SUB / 'submission_v40_cust_prod.csv'
