"""Optimize ensemble weights for v37, mean-scale to v17m, build submission."""
...
print("=== Building submission for v37_pattern (curated top-5) ===")
d = np.load(SCRIPT_DIR / 'ml_v37_pattern_preds.npz', allow_pickle=True)
...
out_path = DIAG_SUB / 'submission_v37_cust_prod.csv'
